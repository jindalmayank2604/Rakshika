    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-16">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        ...
        <div className="relative max-w-xs w-full">
          ...
          <input
            ...
            className="w-full bg-white/90 border border-slate-200 rounded-xl pl-9 pr-4 py-2 text-xs text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
          />
        </div>
      </div>
      ...
      {filteredReports.length > 0 ? (
        ...
        <GlassCard className="p-12 text-center space-y-4 max-w-md mx-auto">
          ...
          <div>
            <h4 className="text-base font-bold text-slate-900">No reports found</h4>
